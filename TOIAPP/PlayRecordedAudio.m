...
-(void)playAudioPressed{
    ...
    if (!self.isPaused) {
        [self.playButton setBackgroundImage:[UIImage imageNamed:@"audio_stop_btn.png"]
       ...
       //start a timer to update the time label display
        ...
        [self.playButton setBackgroundImage:[UIImage imageNamed:@"audio_recording_play.png"]
                                   forState:UIControlStateNormal];
